...
var Carousel = function Carousel(_ref) {
  ...
  var _useState = React.useState(data.length > 2 ? 1 : 0),
  ...
  return React__default.createElement("div", {
    ...
    }), item.headerText && React__default.createElement("p", {
    ...
    }, item.headerText), item.subText && React__default.createElement("p", {
      className: "sub-text " + (subTextType === 'white' ? 'sub-text-white' : 'sub-text-black') + "\n                 " + (size === 'normal' ? 'sub-text-normal-size' : 'sub-text-large-size')
    }, item.subText), index === activeItem && React__default.createElement("div", {
      className: "active-render-item"
    }, leftItem ? React__default.createElement("div", {
      onClick: function onClick() {
        return handleNextSlide(false);
      },
      className: "custom-item"
    }, leftItem) : React__default.createElement("span", {
      className: "default-item",
      onClick: function onClick() {
        return handleNextSlide(false);
      }
    }, "\u2190"), rightItem ? React__default.createElement("div", {
      onClick: function onClick() {
        return handleNextSlide(true);
      },
      className: "custom-item"
    }, rightItem) : React__default.createElement("span", {
      className: "default-item",
      onClick: function onClick() {
        return handleNextSlide(true);
      }
...
//# sourceMappingURL=react-carousel.cjs.development.js.map
